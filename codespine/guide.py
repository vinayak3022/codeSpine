...
GUIDE_SECTIONS: list[dict] = [
    ...
    },
    {
        ...
        "tools": [
            ...
            {"name": "answer", "one_liner": "GraphRAG answer surface with graph-aware diverse reranking, citations, confidence, latency observability, versioned provenance, index fingerprint, cache-aware execution, and safe abstention on ambiguity or weak grounding."},
    ...
    },
    {
        ...
        "body": (
            ...
            "  traces, match reasons, confidence explanations, versioned provenance, and index fingerprint.\n"
            "- Use answer(question, project=...) for a GraphRAG response with graph-aware diverse\n"
            "  reranking, evidence subgraph, citations, confidence, observability metadata,\n"
            "  versioned provenance, index fingerprint, and trust-preserving abstention\n"
            "  when the symbol is ambiguous or weakly grounded.\n"
